    ...
    <div className="container mx-auto py-10">
      ...
      <div className="space-y-8">
        {INTERVIEW_CATEGORY.map((category) => {
          const interviewsByCategory = groupedInterviews[category.id];

          if (!interviewsByCategory || interviewsByCategory.length === 0) {
            return null;
          }
            ...
            <section key={category.id}>
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <Badge variant={category.variant}>
                  {interviewsByCategory.length}
                </Badge>
              </div>

              {/* INTERVIEW CARDS */}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {interviewsByCategory.map((interview: Interview) => {
